...
$query="insert into user values('','$n','$e','$pass','$mob','$gen','$hob','$imageName','$sess','$dob',now())";
...
$err="<font color='blue'>Registration successfull. You Can login !!!</font>";
...
?>
<h2><center>CSE Student Registration Form</center></h2>
